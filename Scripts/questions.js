...
// 4 câu đầu (index 0-3) cho LEVEL 1: Nhận diện tin nhắn & đường link lừa đảo (Màn 0)
// 4 câu tiếp (index 4-7) cho LEVEL 2: Lừa đảo tài chính & đầu tư (Màn 1)
// 4 câu cuối (index 8-11) cho LEVEL 3: Bảo mật cá nhân, Tống tiền, Deepfake (Màn 2)
...
const gameQuestions = [
    ...
    // -----------------------------------------------------
    {
        ...
        correct: 2, // Đáp án C
        explanation: "Các đường link trúng thưởng là chiêu dụ đánh cắp thông tin cá nhân hoặc cài mã độc. Không nhấp vào, hãy báo cáo nhà mạng hoặc cơ quan chức năng."
    },
    {
        ...
        correct: 1, // Đáp án B
        explanation: "Trang lừa đảo thường “nhái” tên miền thật, thêm ký tự lạ hoặc không có “https://” – chứng chỉ bảo mật SSL."
    },
    {
    ...
    {
        question: "Khi nhận cuộc gọi tự xưng “Công an điều tra rửa tiền” và yêu cầu chuyển tiền để chứng minh vô tội, bạn nên:",
        options: [
